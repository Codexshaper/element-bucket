...
class Team_Member extends Widget {
	...
	public function get_title() {
		return __( 'EB Team Member', 'elementbucket-lite' );
	}
	...
	public function get_keywords() {
		return array( 'Team Member', 'CodexShaper', 'Element Bucket' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style_select',
			array(
				'label'   => esc_html__( 'Select Style', 'elementbucket-lite' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'style-1' => esc_html__( 'Style-1', 'elementbucket-lite' ),
					'style-2' => esc_html__( 'Style-2', 'elementbucket-lite' ),
				),
				'default' => 'style-1',
			)
		);
		...
		$this->add_control(
			'profile',
			array(
				'label'   => __( 'profile Image', 'elementbucket-lite' ),
		...
		$this->add_control(
			'member_name',
			array(
				'label'   => __( 'Memeber Name', 'elementbucket-lite' ),
		...
		$this->add_control(
			'designation',
			array(
				'label'   => __( 'Designation', 'elementbucket-lite' ),
				'type'    => Controls_Manager::TEXT,
				'default' => ( '' ),
			)
		);
		$this->add_control(
			'profile_link',
			array(
				'label'   => __( 'Profile Link', 'elementbucket-lite' ),
		...
		$this->add_control(
			'show_social_link',
			array(
				'label'        => esc_html__( 'Show Social Link', 'elementbucket-lite' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'elementbucket-lite' ),
				'label_off'    => esc_html__( 'Hide', 'elementbucket-lite' ),
				'return_value' => 'yes',
				'default'      => 'yes',
				'condition'    => array(
		...
		$this->add_control(
			'social_btn_icon',
			array(
				'label'     => esc_html__( 'Social Button Icon', 'elementbucket-lite' ),
		...
		$reapeater->add_control(
			'social_link',
			array(
				'label'   => __( 'Social Media Link', 'elementbucket-lite' ),
				'type'    => Controls_Manager::URL,
				'default' =>
				array(
					'url'         => '#',
		...
		$this->add_control(
			'Social_icon',
			array(
				'label'  => __( 'Social Icon Item', 'elementbucket-lite' ),
		...
		$this->start_controls_section(
			'styling_section_two',
			array(
				'label' => __( 'Name Settings', 'elementbucket-lite' ),
		...
		$this->start_controls_tab(
			'style_normal_tab',
			array(
				'label' => esc_html__( 'Normal', 'elementbucket-lite' ),
			)
		);
		$this->add_control(
			'member_name_color',
			array(
				'label'     => __( 'Member Name Color', 'elementbucket-lite' ),
		...
		$this->add_group_control(
			...
			array(
				...
				'label'     => __( 'Member Name Typography', 'elementbucket-lite' ),
		...
		$this->start_controls_tab(
			'style_hover_tab',
			array(
				'label' => esc_html__( 'Hover', 'elementbucket-lite' ),
			)
		);
		$this->add_control(
			'name_hover_color',
			array(
				'label'     => __( 'Name Hover Color', 'elementbucket-lite' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => ( '#F7C600' ),
				'selectors' => array(
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Social Icon Settings', 'elementbucket-lite' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		$this->start_controls_tabs(
		...
		$this->add_control(
			'Icon_width',
			array(
				'label'      => __( 'Icon Width', 'elementbucket-lite' ),
		...
		$this->add_control(
			'icon_height',
			array(
				'label'      => __( 'Icon Height', 'elementbucket-lite' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%', 'em', 'rem', 'custom' ),
				'selectors'  => array(
		...
		$this->add_control(
			'icon_border_radious',
			array(
				'label'      => __( 'Icon Border Radious', 'elementbucket-lite' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%', 'em', 'rem', 'custom' ),
				'selectors'  => array(
		...
		$this->add_control(
			'bg_color',
			array(
				'label'     => __( 'Background Color', 'elementbucket-lite' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Social Icon Background Color', 'elementbucket-lite' ),
				'type'      => Controls_Manager::COLOR,
				'condition' => array(
					'style_select' => 'style-2',
				),
		...
		$this->add_control(
			'bg_color_hover',
			array(
				'label'     => __( 'Hover Background Color', 'elementbucket-lite' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Background Hover Color', 'elementbucket-lite' ),
				'type'      => Controls_Manager::COLOR,
				'condition' => array(
					'style_select' => 'style-2',
				),
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Designation Settings', 'elementbucket-lite' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		$this->add_control(
			...
			array(
				'label'     => __( 'Member Designation Color', 'elementbucket-lite' ),
				'type'      => Controls_Manager::COLOR,
				'condition' => array(
					'style_select' => 'style-1',
				),
		...
		$this->add_group_control(
			...
			array(
				...
				'label'     => __( 'Member Designation Typography', 'elementbucket-lite' ),
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Card Settings', 'elementbucket-lite' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		$this->add_control(
			'card_padding',
			array(
				'label'      => esc_html__( 'Card Padding', 'elementbucket-lite' ),
