...
class Settings {
	...
	public function set_menu_order() {
		global $submenu;
		if ( isset( $submenu['element-bucket'] ) ) {
			unset( $submenu['element-bucket'][0] );
		}
	}
}
