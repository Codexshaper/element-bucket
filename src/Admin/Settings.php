...
namespace CodexShaper\ElementBucketLite\Admin;
...
class Settings {
	 ...
	 * Instance
	 *
	 * @var \CodexShaper\ElementBucketLite\Admin\Settings
	 * @static
	 * @since 1.0.0
	 */
	 ...
	 * @access public
	 * @static
	 * @return \CodexShaper\ElementBucketLite\Admin\Settings An instance of the class.
	 */
	...
	public function set_menu_order() {
		global $submenu;
		if ( isset( $submenu['elementbucket-lite'] ) ) {
			unset( $submenu['elementbucket-lite'][0] );
		}
	}
}
