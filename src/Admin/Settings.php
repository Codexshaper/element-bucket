...
class Settings {
	...
	public function add_menu_pages() {
		...
		add_submenu_page(
			'cs-element-bucket-lite',
			__( 'Dashboard', 'cs-element-bucket-lite' ),
			__( 'Dashboard', 'cs-element-bucket-lite' ),
			'manage_options',
			'eb-dashboard',
		...
		add_submenu_page(
			'cs-element-bucket-lite',
			__( 'Modules', 'cs-element-bucket-lite' ),
			__( 'Modules', 'cs-element-bucket-lite' ),
			'manage_options',
			'eb-core-modules',
	...
	public function set_menu_order() {
		global $submenu;
		if ( isset( $submenu['cs-element-bucket-lite'] ) ) {
			unset( $submenu['cs-element-bucket-lite'][0] );
		}
	}
}
